...
Welcome to ``k_means`` contributor's guide.
...
If you experience bugs or general issues with ``k_means``, please have a look
...
You can help improve ``k_means`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``k_means`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``k_means``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n k_means python=3 six virtualenv pytest pytest-cov
    conda activate k_means
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/k_means.git
    cd k_means
...
#. Install |pre-commit|_::
   ...
   ``k_means`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/k_means
.. _issue tracker: https://github.com/<USERNAME>/k_means/issues
.. <-- end -->
